...
if ($current_user) $write_link = "href='/research-write'";
...
?>
    <!-- 서브 영역 -->
    <div class="fc02 study" id="main-content"><!-- 카테고리 코드 : study,event,lab,user -->
        <div class="th01">
            <dl class="inner">
                <dt>연구</dt>
        ...
        <div class="inner tc01">
            <!-- 컨텐츠 영역 -->
            <div class="fc03">
                <a class="btn03 leftSide" <?php echo $write_link; ?>>연구 글쓰기</a>
                <form class="cf04 rightSide" action="<?php echo esc_url(home_url('/archives/research')); ?>"
                      method="get">
